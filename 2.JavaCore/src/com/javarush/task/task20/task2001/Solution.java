...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File task2001File = File.createTempFile("task2001File", null);
            OutputStream outputStream = new FileOutputStream(task2001File);
            InputStream inputStream = new FileInputStream(task2001File);
            ...
            System.out.println("ivanov equals to somePerson:" + ivanov.equals(somePerson));
